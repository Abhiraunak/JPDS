    ...
    return (
        <>
            ...
            <section className="flex flex-col items-center gap-5 bg-[#F7F4EDff] px-4 pb-20">
                <ProjectCard imageUrl="/naturopathy/center1.jpg" />
                <ProjectCard imageUrl="/naturopathy/center2.jpg" />
                <ProjectCard imageUrl="/naturopathy/center3.jpg" />
                <ProjectCard imageUrl="/naturopathy/center4.jpg" />
                <ProjectCard imageUrl="/naturopathy/center5.jpg" />
                <ProjectCard imageUrl="/naturopathy/center6.jpg" />
                <ProjectCard imageUrl="/naturopathy/center7.jpg" />
                <ProjectCard imageUrl="/naturopathy/center8.jpg" />
                <ProjectCard imageUrl="/naturopathy/center9.jpg" />
                <ProjectCard imageUrl="/naturopathy/center10.jpg" />
            </section>
        </>
    )
}