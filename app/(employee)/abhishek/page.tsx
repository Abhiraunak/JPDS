        ...
        <div className="max-w-6xl mx-auto mt-30 px-4 py-12 flex flex-col md:flex-row gap-10 md:gap-16">
            ...
            <div className="flex-1 mt-4 md:mt-0">
                ...
                <div className="space-y-6 text-neutral-700 font-light leading-relaxed text-base md:text-lg text-justify md:text-left">
                    <p>
                        Abhishek is a software developer working with the team to integrate technology into the design and project workflow. He develops digital tools and systems that support design development, data management, and project coordination.
                    </p>
                    <p>
                        His work focuses on improving efficiency through automation, visualization support, and customized software solutions that assist the team in handling complex landscape and architectural projects more effectively.
                    </p>
